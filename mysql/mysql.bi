...
#include once "mysql_com.bi"
#include once "mysql_version.bi"
...
type as any st_mysql_stmt
type as st_mysql_stmt MYSQL_STMT

type st_mysql_bind
  as ulong buffer_type
  as zstring ptr buffer
  as ulong buffer_length
  as ulong ptr length
  as my_bool ptr is_null
  as my_bool ptr is_unsigned
  as my_bool ptr error_
end type

type as st_mysql_bind MYSQL_BIND

declare function _
  mysql_stmt_init alias "mysql_stmt_init"( _
    byval as MYSQL ptr ) _
  as MYSQL_STMT ptr
declare function _
  mysql_stmt_close alias "mysql_stmt_close"( _
    byval as MYSQL_STMT ptr ) _
  as my_bool
declare function _
  mysql_stmt_prepare alias "mysql_stmt_prepare"( _
    byval as MYSQL_STMT ptr, _
    byval as zstring ptr, _
    byval as ulong ) _
  as long
declare function _
  mysql_stmt_bind_param alias "mysql_stmt_bind_param"( _
    byval as MYSQL_STMT ptr, _
    byval as MYSQL_BIND ptr ) _
  as my_bool
declare function _
  mysql_stmt_send_long_data alias "mysql_stmt_send_long_data"( _
    byval as MYSQL_STMT ptr, _
    byval as ulong, _
    byval as any ptr, _
    byval as ulong ) _
  as my_bool
declare function _
  mysql_stmt_execute alias "mysql_stmt_execute"( _
    byval as MYSQL_STMT ptr ) _
  as long
declare function _
  mysql_stmt_error alias "mysql_stmt_error"( _
    byval as MYSQL_STMT ptr ) _
  as zstring ptr
...
declare function _
  mysql_real_connect alias "mysql_real_connect" ( _
    byval mysql as MYSQL ptr, _
    byval host as zstring ptr, _
    byval user as zstring ptr, _
    byval passwd as zstring ptr, _
    byval db as zstring ptr, _
    byval port as uinteger, _
    byval unix_socket as zstring ptr, _
    byval clientflag as uinteger) as MYSQL ptr
declare sub _
  mysql_close alias "mysql_close" ( _
    byval sock as MYSQL ptr)
declare function _
  mysql_select_db alias "mysql_select_db" ( _
    byval mysql as MYSQL ptr, _
    byval db as zstring ptr) as integer
declare function _
  mysql_query alias "mysql_query" ( _
    byval mysql as MYSQL ptr, _
    byval q as zstring ptr) as integer
declare function _
  mysql_send_query alias "mysql_send_query" ( _
    byval mysql as MYSQL ptr, _
    byval q as zstring ptr, _
    byval length as uinteger) as integer
declare function _
  mysql_read_query_result alias "mysql_read_query_result" ( _
    byval mysql as MYSQL ptr) as integer
declare function _
  mysql_real_query alias "mysql_real_query" ( _
    byval mysql as MYSQL ptr, _
    byval q as zstring ptr, _
    byval length as uinteger) as integer
...
declare function _
  mysql_real_escape_string alias "mysql_real_escape_string" ( _
    byval mysql as MYSQL ptr, _
    byval to as zstring ptr, _
